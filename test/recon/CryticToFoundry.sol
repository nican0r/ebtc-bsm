...
// forge test --match-test test_property_assets_are_not_lost_net_0 -vvv 
function test_property_assets_are_not_lost_net_0() public {

    bsmTester_sellAsset(1);

    bsmTester_buyAsset(1);

    property_assets_are_not_lost_net();

 }

// forge test --match-test test_property_assets_are_not_lost_1 -vvv 
function test_property_assets_are_not_lost_1() public {
